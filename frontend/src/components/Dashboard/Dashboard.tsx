      ...
      <Resizable
        ...
        handleComponent={{
          right: (
            ...
            >
              <button
                className={`collapse-button absolute top-[9px] z-20 flex cursor-pointer items-center justify-center rounded-full border-2 border-faded_border bg-white opacity-0 hover:bg-faded_bg group-hover:opacity-100 group-active:opacity-100 ${
